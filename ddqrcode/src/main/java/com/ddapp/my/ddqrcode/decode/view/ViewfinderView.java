...
package com.ddapp.my.ddqrcode.decode.view;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			Rect targetRect = new Rect(frame.left, frame.top + 60, frame.right, frame.top + 30);
			...
			canvas.drawText(getContext().getString(R.string.dingdone_string_676), targetRect.centerX(),
					(float) (frame.top - (float) TEXT_PADDING_TOP * density / 2), paint);
